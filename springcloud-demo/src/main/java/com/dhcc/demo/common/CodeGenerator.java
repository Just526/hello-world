...
public class CodeGenerator {
     ...
     * </p>
     */
    public static ResourceBundle config=ResourceBundle.getBundle("generator");
...
//        gc.setIdType(IdType.AUTO);
        ...
        pc.setParent(config.getString("package.name"));
